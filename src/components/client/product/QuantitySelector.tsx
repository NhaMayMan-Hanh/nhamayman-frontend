...
export default function QuantitySelector({ quantity, setQuantity, max, disabled }: Props) {
  return (
    <div>
      ...
      <div className="flex items-center gap-3">
        <button
          ...
          className="flex justify-center items-center w-12 h-12 border rounded-lg hover:bg-gray-50 disabled:opacity-50"
        >
          <Minus size={20} />
        </button>
        <input

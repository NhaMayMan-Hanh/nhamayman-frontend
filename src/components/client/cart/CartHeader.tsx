    ...
    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 p-4 bg-white rounded-lg shadow">
      <div className="flex items-center gap-3">
        ...
        <span className="font-medium text-gray-700">
          Chọn tất cả (<span className="text-orange-600">{selectedCount}</span>/{totalCount})
        </span>
      </div>
      ...
      {hasSelected && (
        <button
          ...
          className="px-5 py-2.5 text-sm font-medium text-red-600 bg-red-50 rounded-lg hover:bg-red-100 transition"
        >

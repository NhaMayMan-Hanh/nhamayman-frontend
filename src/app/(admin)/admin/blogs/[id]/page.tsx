    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="px-4 py-8">
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <img src={`${blog.img}`} alt={blog.name} className="w-full h-96 object-cover" />

          {/* Content */}
          <div className="p-8 md:p-12">
            {/* Title */}
            <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">{blog.name}</h1>
            ...
            <div className="bg-pink-50 border-l-4 border-pink-600 p-4 rounded-r-lg mb-8">
              <p className="text-gray-700 italic text-lg">{blog.description}</p>
            </div>
        ...
        <div className="mt-8 bg-white rounded-2xl shadow-lg p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            <div>
              ...
              <span className="ml-2 text-gray-900 font-medium">{blog.slug}</span>
            </div>
            <div>
              <span className="text-gray-600">Cập nhật:</span>
              <span className="ml-2 text-gray-900 font-medium">{formatDate(blog.updatedAt)}</span>
            </div>
          </div>
        </div>
      </div>

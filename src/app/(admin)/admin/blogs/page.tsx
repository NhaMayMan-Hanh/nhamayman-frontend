  ...
  const confirmDelete = async () => {
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/admin/blogs/${selectedBlog._id}`,
    ...
    <div className="min-h-screen bg-gray-50">
      <div>
        <div className="mb-6 sm:mb-8">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Quản lý Blogs</h1>
                ...
                {paginatedBlogs.length === 0 ? (
                  <tr>
                    <td colSpan={5} className="px-6 py-12 text-center text-gray-500">
                      ...
                      <p className="text-lg font-medium">Không tìm thấy blog nào</p>

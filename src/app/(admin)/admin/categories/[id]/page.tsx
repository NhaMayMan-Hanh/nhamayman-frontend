    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gray-50">
        <div className="bg-red-50 border border-red-200 rounded-lg p-8 text-center max-w-md">
          ...
          <h3 className="text-lg font-semibold text-red-800">Không tìm thấy danh mục</h3>
          <p className="text-red-600 mt-2">{error || "Danh mục không tồn tại hoặc đã bị xóa"}</p>
          <button
    ...
    <div className="min-h-screen bg-gray-50 p-4 sm:p-6 lg:p-8">
      <div>
        ...
        <div className="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Chi tiết danh mục</h1>
            <p className="text-gray-600 mt-1">Xem thông tin chi tiết về danh mục sản phẩm</p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-1">
            <div className="bg-white rounded-xl shadow-sm overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-lg text-blue-600 font-medium mt-2">/{category.slug}</p>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-3">Mô tả danh mục</h3>
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <p className="font-medium mt-1">{formatDate(category.createdAt)}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-500">Cập nhật lần cuối</p>
                  <p className="font-medium mt-1">{formatDate(category.updatedAt)}</p>
                </div>
                <div>

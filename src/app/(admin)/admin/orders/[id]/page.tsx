      ...
      <div>
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div>
              ...
              <p className="text-slate-600 mt-1">
                Mã đơn: <span className="font-mono font-semibold text-blue-600">{order._id}</span>
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              <h3 className="text-lg font-semibold text-slate-800 mb-4">Phương thức thanh toán</h3>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden">
              <div className="px-6 py-4 bg-gradient-to-r from-slate-50 to-slate-100 border-b border-slate-200">
                <h3 className="text-lg font-semibold text-slate-800">Sản phẩm trong đơn hàng</h3>
              </div>
              ...
              <div className="space-y-4 text-lg">
                ...
                <div className="border-t-2 border-slate-200 pt-4">
                  <div className="flex justify-between font-bold text-xl">
                    <span>Tổng cộng</span>
                    <span className="text-red-600">{order.total.toLocaleString("vi-VN")}₫</span>
                  </div>
                </div>
              </div>
            </div>

    ...
    return (
      <div className="flex items-center justify-center h-screen bg-slate-50">
        <div className="text-center bg-white p-8 rounded-xl shadow-md">
          ...
          <p className="text-red-600 font-medium mb-4">{error || "Không tìm thấy sản phẩm"}</p>
          <button
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {product.detailedDescription && (
            <div className="bg-white rounded-xl shadow-sm p-6">
              <h2 className="text-xl font-bold text-slate-800 mb-4">Mô tả chi tiết</h2>
          ...
          {/* Meta Info */}
          <div className="bg-white rounded-xl shadow-sm p-6">
            <h2 className="text-xl font-bold text-slate-800 mb-4">Thông tin hệ thống</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="flex items-center gap-3 p-3 bg-slate-50 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-slate-800 font-mono">{product._id}</p>
                </div>
              </div>
              <div className="flex items-center gap-3 p-3 bg-slate-50 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-slate-800">v{product.__v}</p>
                </div>
              </div>
            </div>
          </div>

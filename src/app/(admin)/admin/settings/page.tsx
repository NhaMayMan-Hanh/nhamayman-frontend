...
export default function Settings() {
   ...
   const handleAvatarUpload = async (
      ...
      try {
         const res = await fetch(
            "http://localhost:5000/api/client/users/upload-avatar",
            {
               method: "POST",
               credentials: "include",
               body: formData,
   ...
   const handleSaveProfile = async () => {
      ...
      try {
         const res = await fetch(
            "http://localhost:5000/api/client/users/update-profile",
            {
               method: "PUT",
               credentials: "include",
               headers: {
   ...
   const handleChangePassword = async () => {
      ...
      try {
         const res = await fetch(
            "http://localhost:5000/api/client/users/change-password",
            {
               method: "PUT",
               credentials: "include",
               headers: {
         ...
         <div>
            ...
            <div className="mb-6 sm:mb-8">
               ...
               <p className="text-gray-600 mt-2">
                  Quản lý cài đặt hệ thống và tài khoản của bạn
               </p>
            </div>
                     ...
                     <div className="space-y-4">
                        <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                           <div>
                              ...
                              <p className="text-sm text-gray-600">
                                 Bảo mật tài khoản với xác thực hai lớp
                              </p>
                           </div>
                           <button
                              onClick={() =>
                        ...
                        <div>
                           ...
                           />
                           <p className="text-sm text-gray-600 mt-1">
                              Yêu cầu đổi mật khẩu sau số ngày này
                           </p>
                        </div>
                     </div>
                     ...
                     <div className="space-y-4">
                           ...
                           <button
                              onClick={() =>
                                 setNotificationSettings({
                                    ...notificationSettings,
                                    newUserAlert:
                                       !notificationSettings.newUserAlert,
                                 })
                              }
                              className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                                 notificationSettings.newUserAlert
                        ...
                        <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                           <div>
                              ...
                              <p className="text-sm text-gray-600">
                                 Thông báo khi có blog mới được tạo
                              </p>
                           </div>
                           <button
                              onClick={() =>
                                 setNotificationSettings({
                                    ...notificationSettings,
                                    newBlogAlert:
                                       !notificationSettings.newBlogAlert,
                                 })
                              }
                              className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                                 notificationSettings.newBlogAlert

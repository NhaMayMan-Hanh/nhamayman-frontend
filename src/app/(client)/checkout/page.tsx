            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 mb-5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  />
                  {errors.dien_thoai && (
                    <p className="text-red-500 text-sm mt-1">{errors.dien_thoai}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  />
                  {errors.tinh_thanh && (
                    <p className="text-red-500 text-sm mt-1">{errors.tinh_thanh}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  />
                  {errors.quan_huyen && (
                    <p className="text-red-500 text-sm mt-1">{errors.quan_huyen}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  />
                  {errors.phuong_xa && (
                    <p className="text-red-500 text-sm mt-1">{errors.phuong_xa}</p>
                  )}
                </div>

...
export default function CheckoutPage() {
      ...
      try {
         ...
         const validItems = items.filter(
            (i) =>
               i._id &&
               i.ten_sp &&
               typeof i.gia_mua === "number" &&
               typeof i.so_luong === "number"
         );
         ...
         try {
            ...
            if (donhang.quan_huyen) {
               const district = data.districts?.find(
                  (d: District) => d.name === donhang.quan_huyen
               );
         ...
         try {
            ...
            if (donhang.phuong_xa) {
               const ward = data.wards?.find(
                  (w: Ward) => w.name === donhang.phuong_xa
               );
   ...
   useEffect(() => {
      const fetchUserProfile = async () => {
         ...
         try {
            const res = await fetch(
               `${process.env.NEXT_PUBLIC_API_URL}/client/users/profile`,
               {
                  credentials: "include",
               }
            );
   ...
   const tongTien = checkoutItems.reduce(
      (sum, sp) => sum + sp.gia_mua * sp.so_luong,
      0
   );
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                     ...
                     <div>
                        ...
                        <input
                           ...
                           onChange={(e) =>
                              handleChange("dien_thoai", e.target.value)
                           }
                     ...
                     <div>
                        ...
                        <input
                           ...
                           onChange={(e) =>
                              handleChange("dia_chi_chi_tiet", e.target.value)
                           }
                     ...
                     <div className="md:col-span-2">
                        ...
                        <textarea
                           ...
                           onChange={(e) =>
                              handleChange("ghi_chu", e.target.value)
                           }
                           rows={3}
                           className="w-full border-2 border-gray-200 rounded-xl px-4 py-3 focus:border-orange-600 focus:outline-none transition"
            ...
            <div className="lg:col-span-1">
               <div className="bg-white rounded-2xl shadow-lg p-6 sticky top-24">
                  ...
                  <button
                     ...
                     className="w-full bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white py-4 rounded-lg font-bold transition-all shadow-lg hover:shadow-xl disabled:opacity-50 cursor-pointer"
                  >
            ...
            <div className="fixed bg-black/40 inset-0 bg-opacity-50 flex items-center justify-center z-50 p-4">
               <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6">
                  ...
                  <div className="space-y-2 text-sm">
                     ...
                     <p>
                        <strong>Địa chỉ:</strong> {donhang.dia_chi_chi_tiet},{" "}
                        {donhang.phuong_xa}, {donhang.quan_huyen},{" "}
                        {donhang.tinh_thanh}
                     </p>

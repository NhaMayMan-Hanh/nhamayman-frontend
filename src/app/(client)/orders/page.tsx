                        ...
                        {statusTabs.map((tab) => {
                           ...
                           return (
                              <button
                                 ...
                                 className={`px-4 py-3 -mb-px font-medium border-b-2 transition-colors whitespace-nowrap text-sm ${
                                    activeTab === tab.key
                                    ...
                                    <div className="border-t pt-3 flex justify-between items-center">
                                       ...
                                       {order.status === "pending" && (
                                          <button
                                             ...
                                             className="px-5 py-2 bg-red-500 text-white text-sm font-medium rounded-lg hover:bg-red-600 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors"
                                          >
                                             {cancellingOrderId === order._id
                                                ? "Đang hủy..."
                                                : "Hủy đơn hàng"}
